...
@page { margin: 0; }
	...
	if($sql ="select * from payment where id = '$pid' ");
	...
	?>
		<header>
			...
			<address >
				<p>RestSide,</p>
				<p>Mumbai,<br>Maharashtra,<br>India.</p>
				<p>+91 9082456712</p>
			</address>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- restside@info.com || Web :- wwwRestSide.com || Phone :- +91 9082456712</p>
			</div>
		</aside>
	</body>
</html>
