        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="users.php"><i class="fa fa-plus-circle"></i>Users</a>
                    </li>
				        	<li>
                    ...
                    <li>
                        <a   href="room_upload.php"><i class="fa fa-pencil-square-o"></i>Edit Room Card</a>
                    </li>
                    <li>
