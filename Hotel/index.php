				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="register">Register</a></li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<p>Providing guests unique and enchanting views from their rooms with its exceptional amenities, makes RestSide one of bests in its kind.Try our food menu, awesome services and friendly staff while you are here.</p>
									</div>
								</div>
							</div>
						</div>
...
<div class="col-md-12 book-form-left-w3layouts #E7717D">
...
<!-- //gallery -->
  ...
  <p class="w3-center w3-large">Rooms avaliable for you.. </p><br><br>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom ">
      <div class="w3-card w3-hover-shadow" class="rcorners2" id="rcorners2" style="max-height: 450px; min-height: 450px;" >
        ...
        <div class="w3-container">
          ...
          <center><button class="w3-button w3-dark w3-block button1"><i class="fa fa-envelope"></i><a href="login.php"> Book Now</a></button></center>
        </div>
      </div>
    </div>
